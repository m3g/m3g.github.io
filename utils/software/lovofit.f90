...
if ( ioerror /= 0 ) call error(2)

read(10,*,iostat=ioerror) nvar, ndata, fraction
if(ioerror /= 0) call error(3)
...
select case(i) 
  ...
  case(3) 
    write(*,*) ' ERROR: Could not nvar and ndata from first line of data file. '
  case(4)
    write(*,*) ' ERROR: Could not read data file. '
  case(5) 
